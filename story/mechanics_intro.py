...
class MechanicsStorylineMixin:
    ...
    def remember_rebecca(self):
        ...
        if self.has_item("Third Eye"):
            type.type("The " + cyan(bright("Third Eye")) + " makes the dream crystalline. Every detail is memorized.")
            print()
            type.type("The mechanic speaks clearly. You hear words that were whispered before. Names. Dates. Places.")
            self.restore_sanity(8)
            print()
        if self.has_item("Lucid Dreaming Kit"):
            type.type("The " + magenta(bright("Lucid Dreaming Kit")) + " enhances the mechanic's dream. Details sharpen. Secrets surface.")
            print()
