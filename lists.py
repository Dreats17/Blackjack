...
class Lists:
    ...
    def make_pawn_shop_prices(self):
        ...
        return {
            ...
            # New Crafted Items — Tier 1 Gadgets
            "Headlamp": 28,
            "Spotlight": 55,
            "Evidence Kit": 45,
            "Radio Jammer": 40,
            ...
            "Security Bypass": 35,
            # Tier 1 Disguises
            "Low-Profile Outfit": 20,
            "Beach Bum Disguise": 18,
            "Gas Mask": 35,
            "Storm Suit": 18,
            "Brass Knuckles": 70,
            "Gentleman's Charm": 200,
            "Forged Documents": 60,
            # Tier 1 Tonics
            "Antacid Brew": 8,
            "Trail Mix Bomb": 10,
            ...
            # Tier 1 Luxury
            "Kingpin Look": 350,
            "Enchanted Vintage": 400,
            "Heirloom Set": 500,
            "Aristocrat's Touch": 250,
            "Power Move Kit": 300,
            ...
            "Fire Launcher": 75,
            "Tear Gas": 50,
            "Street Fighter Set": 100,
            "Survival Bivouac": 40,
            "Hydration Station": 35,
            "Provider's Kit": 50,
            "Fortified Perimeter": 55,
            "All-Weather Armor": 45,
            "Master Key": 80,
            "Night Scope": 65,
            "SOS Kit": 30,
            "Intelligence Dossier": 100,
            "Surveillance Suite": 90,
            "Mind Shield": 30,
            "Fortune's Favor": 200,
            "Fate Reader": 50,
            "Lucid Dreaming Kit": 80,
            "Old Money Identity": 500,
            "New Identity": 100,
            "Beast Tamer Kit": 30,
            "Cheater's Insurance": 60,
            "Roadside Shield": 100,
            "Auto Mechanic": 120,
            "Rolling Fortress": 110,
            # Tier 3 Masterworks
            "Road Warrior Armor": 300,
            "Third Eye": 200,
            "Nomad's Camp": 150,
            "All-Access Pass": 350,
            "Master of Games": 800,
            "Immortal Vehicle": 500,
            "Gambler's Aura": 400,
            "Ark Master's Horn": 250,
            "Guardian Angel": 300,
            "Hazmat Suit": 150,
            "Ghost Protocol": 400,
            "Dark Pact Reliquary": 200,
            # Tier 4 Legendary
            "Beastslayer Mantle": 1000,
            "Seer's Chronicle": 1000,
            "Wanderer's Rest": 800,
            "Skeleton Key": 1500,
            "King of the Road": 2000,
            "War Wagon": 1800,
            "Moonlit Fortune": 2000,
            "Leviathan's Call": 1500,
            "Last Breath Locket": 5000,
            "Phantom Rose": 2500,
            "Soul Forge": 3000,
    ...
    def make_crafting_recipes(self):
        ...
        return {
            ...
            "Headlamp": {
                ...
                "description": "Hands-free light source. Night events: see threats earlier.",
                "pawn_value": 28,
                "category": "gadget",
                "craft_text": "You duct tape the flashlight to your forehead. It falls off. You add more tape. It falls off again. You tape it to a headband THEN tape the headband to your skull. It holds. You look like an idiot. You can see in the dark. Trade-offs.",
            ...
            "Spotlight": {
                "ingredients": ["Flashlight", "Binoculars"],
                "description": "Long-range illumination. Adventures: reveal hidden paths.",
                "pawn_value": 55,
                "category": "gadget",
                "craft_text": "You shove the flashlight into the binoculars backwards. Then forwards. Then sideways. Fifteen minutes of confused optics later, you accidentally create a beam that could guide aircraft. You have no idea which angle made it work. Don't touch it.",
                "hint_vague": "Focused vision, magnified brilliance.",
                "hint_suggestive": "A gadget combining illumination with magnification.",
                "tier": 1,
            },
            "Evidence Kit": {
                "ingredients": ["Disposable Camera", "Signal Booster"],
                "description": "Document crimes/events. Dark events: leverage over NPCs.",
                "pawn_value": 45,
                "category": "gadget",
                "craft_text": "You wire the camera to the signal booster with a paperclip and hope. The first test photo transmits four miles and also to a random fax machine in Guatemala. Good enough.",
                "hint_vague": "A snapshot and a signal — truth finds a way.",
                "hint_suggestive": "A gadget for documentation. Camera meets communication.",
                "tier": 1,
            },
            "Radio Jammer": {
                "ingredients": ["Signal Booster", "Spare Fuses"],
                "description": "Block signals. Wealth events: avoid casino surveillance.",
                "pawn_value": 40,
                "category": "gadget",
                "craft_text": "\"Reverse the polarity\" sounded smart when you said it. What you actually did was unscrew things until the signal booster started screaming static. Nothing within earshot gets a signal. Including your own phone. Didn't think that through.",
                "hint_vague": "Silence the airwaves, muffle the noise.",
                "hint_suggestive": "A gadget that disrupts signals. Boost meets spark.",
                "tier": 1,
            },
            "EMP Device": {
                "ingredients": ["Battery Terminal Cleaner", "Spare Fuses"],
                "description": "Short-circuit electronics. Dark/casino events: disable systems.",
                "pawn_value": 50,
                "category": "gadget",
                "craft_text": "You pour battery acid on wires while holding your breath. Something sparks. Something else sparks. Everything in a twenty-foot radius goes dark, including the streetlamp you were working under. You finish assembly by feel. Your hands are shaking.",
                "hint_vague": "Dead circuits, fried connections.",
                "hint_suggestive": "A gadget that kills electronics. Battery cleaner meets fuses.",
                "tier": 1,
            },
            "Distress Beacon": {
                "ingredients": ["LifeAlert", "Signal Booster"],
                "description": "Enhanced emergency signal. Survival: guaranteed rescue.",
                "pawn_value": 90,
                "category": "gadget",
                "craft_text": "You crack open the LifeAlert and solder the signal booster's antenna onto it with a lighter and prayers. The range jumps from \"your living room\" to \"three counties.\" The first test alert brings two ambulances and a news helicopter. Overkill, but functional.",
                "hint_vague": "When you scream into the void and it answers.",
                "hint_suggestive": "A gadget for emergencies. Life-saving tech meets signal range.",
                "tier": 1,
            },
            "Security Bypass": {
                "ingredients": ["Padlock", "Pocket Knife"],
                "description": "Open or lock anything. Adventures: access restricted areas.",
                "pawn_value": 35,
                "category": "gadget",
                "craft_text": "You disassemble the padlock to understand how pins work. Then you file the pocket knife into a tension wrench. It takes four hours, three cut fingers, and a moment of enlightenment that would concern a locksmith.",
                "hint_vague": "The locked and the sharp make an unlikely pair.",
                "hint_suggestive": "A gadget for getting through doors. Lock meets blade.",
                "tier": 1,
            },
            ...
            # ══════════════════════════════════════════════════════════════════════
            "Low-Profile Outfit": {
                "ingredients": ["Sunglasses", "Poncho"],
                "description": "Blend with crowds. People events: avoid recognition.",
                "pawn_value": 20,
                "category": "disguise",
                "craft_text": "Sunglasses tucked under the poncho hood. You check your reflection. You look like a background character in your own life. You say \"hello\" to yourself. Even you don't care. Perfect disguise.",
                "hint_vague": "Blend in. Become nobody.",
                "hint_suggestive": "A disguise using eyewear and weather protection.",
                "tier": 1,
            },
            "Beach Bum Disguise": {
                "ingredients": ["Sunglasses", "Cheap Sunscreen"],
                "description": "Look like a tourist. Dark events: muggers ignore tourists.",
                "pawn_value": 18,
                "category": "disguise",
                "craft_text": "Sunscreen applied in thick, visible streaks. Shades at an angle that says \"I have nowhere to be and I've accepted it.\" You test the look on a mirror. The mirror looks away. You've achieved weaponized apathy.",
                "hint_vague": "Sun-kissed anonymity.",
                "hint_suggestive": "A disguise for hot days. Shades and sunscreen.",
                "tier": 1,
            },
            "Gas Mask": {
                "ingredients": ["Welding Goggles", "Air Freshener"],
                "description": "Breathe through anything. Survival: chemical/gas immunity.",
                "pawn_value": 35,
                "category": "disguise",
                "craft_text": "You seal welding goggles with duct tape and shove air freshener filters where the real filters go. Your first breath tastes like a car dealership. Your second breath tastes like surviving. You'll take it.",
                "hint_vague": "Breathe clean in a filthy world.",
                "hint_suggestive": "A disguise for toxic air. Eye protection meets freshness.",
                "tier": 1,
            },
            "Storm Suit": {
                "ingredients": ["Umbrella", "Plastic Poncho"],
                "description": "Full weather protection. Survival: all rain/cold immunity.",
                "pawn_value": 18,
                "category": "disguise",
                "craft_text": "You break the umbrella trying to use it as a frame. You break a second umbrella. The third umbrella cooperates. Poncho over the frame, sealed with tape. You look like a walking tent. Rain hits you and slides right off. Worth every destroyed umbrella.",
                "hint_vague": "Nature's fury, deflected.",
                "hint_suggestive": "A disguise against weather. Rain gear meets rain gear.",
                "tier": 1,
            },
            "Brass Knuckles": {
                "ingredients": ["Leather Gloves", "Padlock"],
                "description": "Hidden weapon. Dark events: auto-win fistfights.",
                "pawn_value": 70,
                "category": "disguise",
                "craft_text": "Getting the padlock to nestle between the glove fingers takes twenty minutes and one accidentally punched workbench. The workbench now has a dent. Your hand now has a bruise. But the NEXT thing you punch will have a bigger dent and a bigger bruise. Science.",
                "hint_vague": "Fist and steel, a brutal marriage.",
                "hint_suggestive": "A weapon disguised as accessory. Gloves meet metal.",
                "tier": 1,
            },
            "Gentleman's Charm": {
                "ingredients": ["Expensive Cologne", "Silk Handkerchief"],
                "description": "Irresistible sophistication. People events: NPCs trust you.",
                "pawn_value": 200,
                "category": "disguise",
                "craft_text": "One drop of cologne on the silk handkerchief. Two drops. Three. The entire gas station smells like a department store. A passing woman actually stops and looks around. You've created a scent radius. Weaponized elegance.",
                "hint_vague": "Smell and silk — the tools of persuasion.",
                "hint_suggestive": "A social disguise. Fragrance meets fine fabric.",
                "tier": 1,
            },
            "Forged Documents": {
                "ingredients": ["Fancy Pen", "Old Photograph"],
                "description": "Fake identity papers. Law: avoid arrest. VIP access.",
                "pawn_value": 60,
                "category": "disguise",
                "craft_text": "Your handwriting is terrible. You practice for thirty minutes. It's still terrible but now it's consistently terrible — and consistency reads as \"official.\" The photo doesn't quite match but you draw the outline of a government seal with a ballpoint pen and frankly it's close enough for anyone who isn't looking hard.",
                "hint_vague": "Ink makes identity.",
                "hint_suggestive": "A disguise on paper. Writing instrument meets memory.",
                "tier": 1,
            },

            # ══════════════════════════════════════════════════════════════════════
            # TIER 1 — TONICS & CONSUMABLES (9)
            # ══════════════════════════════════════════════════════════════════════
            "Antacid Brew": {
                "ingredients": ["Baking Soda", "Water Bottles"],
                "description": "Cure food poisoning/nausea. Illness: prevent stomach events.",
                "pawn_value": 8,
                "category": "tonic",
                "craft_text": "Baking soda into water. Stir. It fizzes like a tiny volcano. You take a test sip and your stomach immediately forgives you for everything you've eaten this week. Grandma was right. She was always right.",
                "hint_vague": "Settle the storm inside.",
                "hint_suggestive": "A tonic for stomach trouble. Powder meets hydration.",
                "tier": 1,
            },
            "Trail Mix Bomb": {
                "ingredients": ["Matches", "Birdseed"],
                "description": "Distraction device. Dark events: escape via diversion.",
                "pawn_value": 10,
                "category": "tonic",
                "craft_text": "Birdseed packed around matches, wrapped in a napkin. You test it by throwing it at a trash can. SEEDS EVERYWHERE. A flock of pigeons appears from nowhere. The matches didn't even light. That's fine. Version two: more matches. Version two works too well.",
                "hint_vague": "Seeds of chaos, ignited.",
                "hint_suggestive": "A consumable surprise. Fire meets feed.",
                "tier": 1,
            },
            "Animal Bait": {
                "ingredients": ["Dog Treat", "Birdseed"],
                "description": "Attract animals. Animal events: companion recruitment.",
                "pawn_value": 12,
                "category": "tonic",
                "craft_text": "Dog treats and birdseed in a ziplock bag. Simple enough. But when you open the bag to test the scent, a pigeon lands on your hand, a squirrel appears on the workbench, and something in the bushes makes a noise. You close the bag quickly. That was a LOT of interest.",
                "hint_vague": "The way to a beast's heart...",
                "hint_suggestive": "A tonic for luring creatures. Treats meet seeds.",
                "tier": 1,
            },
            "Stink Bomb": {
                "ingredients": ["Can of Tuna", "Baking Soda"],
                "description": "Area denial. Dark events: force NPCs to flee.",
                "pawn_value": 8,
                "category": "tonic",
                "craft_text": "You seal the tuna juice and baking soda container and immediately regret every life choice that led to this moment. Your eyes water through the SEALED jar. How? You don't know. Chemistry? A warning from God? The gas station attendant asks you to leave.",
                "hint_vague": "Rotten chemistry at its finest.",
                "hint_suggestive": "A consumable weapon. Fish meets chemistry.",
                "tier": 1,
            },
            "Voice Soother": {
                "ingredients": ["Cough Drops", "Breath Mints"],
                "description": "Clear throat for persuasion. People events: better outcomes.",
                "pawn_value": 10,
                "category": "tonic",
                "craft_text": "Cough drops dissolve into the minty water. You take a sip and hum experimentally. Your voice drops half an octave and smooths out like jazz. You say \"Good evening\" to no one. It sounds like a movie trailer. You practice saying \"Good evening\" six more times.",
                "hint_vague": "Words flow like honey.",
                "hint_suggestive": "A tonic for the throat. Soothing drops meet fresh breath.",
                "tier": 1,
            },
            "Outdoor Shield": {
                "ingredients": ["Cheap Sunscreen", "Bug Spray"],
                "description": "Outdoor protection. Survival: sunburn AND insect block.",
                "pawn_value": 15,
                "category": "tonic",
                "craft_text": "Sunscreen and bug spray swirled together. One coat and the outdoors can't touch you. You apply it to one arm as a test. A mosquito approaches, pivots six inches away, and flies directly into a wall. Effective.",
                "hint_vague": "Sun and bugs bow before you.",
                "hint_suggestive": "A tonic for outdoor protection. Sunblock meets repellent.",
                "tier": 1,
            },
            "Cool Down Kit": {
                "ingredients": ["Premium Sunscreen", "Water Bottles"],
            ...
            "Smoke Flare": {
                "ingredients": ["Matches", "Garbage Bag"],
                "description": "Visible smoke signal. Survival: attract rescue.",
                "pawn_value": 8,
                "category": "tonic",
                "craft_text": "Matches in a garbage bag with trapped air. You seal it, poke a fuse hole, and light a test. Thick, angry smoke billows. You can't see. You can't breathe. You're two feet away and you've lost the workbench. By the time the smoke clears, you've drifted into the parking lot. It works GREAT.",
                "hint_vague": "A dark cloud with a purpose.",
                "hint_suggestive": "A consumable signal. Fire meets plastic.",
                "tier": 1,
            },
            "Vermin Bomb": {
                "ingredients": ["Pest Control", "Baking Soda"],
                "description": "Nuclear pest option. Car events: eliminate pest problems.",
                "pawn_value": 20,
                "category": "tonic",
                "craft_text": "Pest control powder + baking soda accelerant in a sealed cup. The test detonation clears the workbench of ants you didn't know were there. Also the test cup. Also your confidence in the structural integrity of sealed cups. But the rats? They'll be GONE.",
                "hint_vague": "Nuclear option for tiny invaders.",
                "hint_suggestive": "A consumable for pests. Extermination meets chemistry.",
                "tier": 1,
            },
            ...
            # ══════════════════════════════════════════════════════════════════════
            "Eldritch Candle": {
                "ingredients": ["Necronomicon", "Matches"],
                "description": "Cursed light. Dark events: entities obey you. Sanity cost.",
                "pawn_value": 100,
                "category": "dark_arts",
                "craft_text": "You wrap the forbidden pages around the wax. On the third wrap, the candle lights. You didn't light it. Nobody lit it. The flame is green. You blow it out. It relights. You blow harder. It goes out. For now. Your hands are cold. The workbench is cold. Nothing is wrong. Probably.",
                "hint_vague": "Forbidden light, pages that shouldn't be read.",
                "hint_suggestive": "A dark creation. Cursed text meets flame.",
                "tier": 1,
            },
            "Binding Portrait": {
                "ingredients": ["Necronomicon", "Old Photograph"],
                "description": "Trap a person's likeness. People events: blackmail leverage.",
                "pawn_value": 80,
                "category": "dark_arts",
                "craft_text": "Cursed ink from the envelope, applied carefully to the photograph. The pen moves easier than it should — like the ink WANTS to be here. You finish the last symbol and the photograph's subject blinks. Once. Clearly. You put it face-down and don't look at it for an hour.",
                "hint_vague": "A face captured is a soul leashed.",
                "hint_suggestive": "A dark creation. Cursed text meets a frozen moment.",
                "tier": 1,
            },
            "Blackmail Letter": {
                "ingredients": ["Mysterious Envelope", "Fancy Pen"],
                "description": "Anonymous threat. Wealth events: extort NPCs.",
                "pawn_value": 75,
                "category": "dark_arts",
                "craft_text": "You transcribe the envelope's contents in your neatest handwriting. Halfway through, you realize you're writing threats to a person you've never met. The words are elegant. The implications are not. Your hand didn't shake once. That concerns you more than the letter.",
                "hint_vague": "Secrets are currency.",
                "hint_suggestive": "A dark creation. Sealed mystery meets fine writing.",
                "tier": 1,
            },
            "Devil's Deck": {
                "ingredients": ["Deck of Cards", "Matches"],
                "description": "Marked cards. Casino events: cheat any card game.",
                "pawn_value": 30,
                "category": "dark_arts",
                "craft_text": "Pass the cards through the candle flame. Ace of spades first. By the seventh card, the flame bends TOWARD the deck. By the twenty-second, you notice the face cards are looking at you. The jokers? The jokers are grinning. Wider than they were printed.",
                "hint_vague": "Cards that play themselves.",
                "hint_suggestive": "A dark creation. A game meets fire.",
                "tier": 1,
            },
            "Fortune Cards": {
                "ingredients": ["Deck of Cards", "Lucky Penny"],
                "description": "Divination deck. Surreal events: predict/avoid outcomes.",
                "pawn_value": 20,
                "category": "dark_arts",
                "craft_text": "Super glue the penny to the ace of spades. Simple. But when you set the deck down, the cards shuffle. By themselves. Once. Neatly. You pick up the ace. The penny is warm. The deck reshuffles. You put it down, slowly, and step back.",
                "hint_vague": "Luck stacked in your favor, literally.",
                "hint_suggestive": "A dark creation. A game meets a lucky charm.",
                "tier": 1,
            },

            # ══════════════════════════════════════════════════════════════════════
            # TIER 1 — LUXURY CRAFTS (7)
            # ══════════════════════════════════════════════════════════════════════
            "Kingpin Look": {
                "ingredients": ["Gold Chain", "Fancy Cigars"],
                "description": "Crime boss aesthetic. Dark events: criminals respect you.",
                "pawn_value": 350,
                "category": "luxury",
                "craft_text": "Gold chain over the shoulders. Cigars in the pocket. You check the mirror and immediately hate that it works. You look like a man who owns things. You own a Gas Station Parking Lot Workbench Crafting Station. But they don't know that. THEY don't know that.",
                "hint_vague": "Gold and smoke — power dresses itself.",
                "hint_suggestive": "A luxury item. Precious metal meets fine tobacco.",
                "tier": 1,
            },
            "Enchanted Vintage": {
                "ingredients": ["Silver Flask", "Vintage Wine"],
                "description": "Wine never runs out. Social events: infinite toasting.",
                "pawn_value": 400,
                "category": "luxury",
                "craft_text": "Pour the wine into the silver flask. It should taste like regular wine in a nicer container. It doesn't. It tastes BETTER. Like, transcendentally better. You take one more sip to confirm. Then one more. Stop. You're drinking your inventory. Cap it.",
                "hint_vague": "Silver vessel, crimson spirit.",
                "hint_suggestive": "A luxury item. Fine drinkware meets aged wine.",
                "tier": 1,
            },
            "Heirloom Set": {
                "ingredients": ["Antique Pocket Watch", "Fancy Pen"],
                "description": "Looks inherited. Elegance events: old money treatment.",
                "pawn_value": 500,
                "category": "luxury",
                "craft_text": "Pair the watch with the pen. Scratch fake initials into the pen cap with a nail. You hold them together and squint. It looks... inherited? Like someone's rich grandfather left them to you? You never had a rich grandfather. You barely had a regular grandfather. But holding these, you FEEL like you did.",
                "hint_vague": "Time and ink, passed down forever.",
                "hint_suggestive": "A luxury item. Antique timepiece meets writing instrument.",
                "tier": 1,
            },
            "Aristocrat's Touch": {
                "ingredients": ["Leather Gloves", "Silk Handkerchief"],
                "description": "Noble hands. People events: handshake seals any deal.",
                "pawn_value": 250,
                "category": "luxury",
                "craft_text": "Gloves on, silk folded into the pocket. You adjust the silk three times. It has to look effortless, which takes incredible effort. You wave your gloved hand at an imaginary butler. Nobody's watching. You check. Then you do it again.",
                "hint_vague": "Soft hands that command hard rooms.",
                "hint_suggestive": "A luxury item. Fine leather meets fine fabric.",
                "tier": 1,
            },
            "Power Move Kit": {
                "ingredients": ["Monogrammed Lighter", "Fancy Cigars"],
                "description": "Authority look. Business: instant intimidation, better deals.",
                "pawn_value": 300,
                "category": "luxury",
                "craft_text": "Lighter snaps. Cigar catches. You practice the motion — snap, light, lean back — fifteen times. By the eighth, it looks natural. By the fifteenth, you're genuinely concerned that you ENJOY this. You've become the person at the party. You don't even GO to parties.",
                "hint_vague": "The lighter clicks. The room listens.",
                "hint_suggestive": "A luxury item. Personalized flame meets fine tobacco.",
                "tier": 1,
            },
            "Animal Magnetism": {
                "ingredients": ["Expensive Cologne", "Leather Gloves"],
                "description": "Irresistible presence. People: gifts/offers from strangers.",
                "pawn_value": 200,
                "category": "luxury",
                "craft_text": "Apply cologne to the leather gloves. The smell is immediately overwhelming in the best way. You put on the gloves and shake your own hand. Confident. Trustworthy. You convince yourself you're a good person, just from a handshake. This is dangerously effective.",
                "hint_vague": "They can't explain it. They just lean closer.",
                "hint_suggestive": "A luxury item. Fragrance meets leather.",
                "tier": 1,
            },
            "Luck Totem": {
                "ingredients": ["Lucky Rabbit Foot", "Lucky Penny"],
                "description": "Concentrated luck. Passive: +5% all random rolls.",
                "pawn_value": 150,
                "category": "luxury",
                "craft_text": "Tie the rabbit foot to the lucky penny. The knot takes four tries. When it finally holds, the totem SWINGS — toward the northwest, specifically, like a compass. You rotate. It follows northwest. Toward what? You don't know. But something out there is lucky and it's calling you.",
                "hint_vague": "Double the luck, double the superstition.",
                "hint_suggestive": "A luxury item. Two lucky charms become one.",
                "tier": 1,
            },

            # ══════════════════════════════════════════════════════════════════════
            # TIER 1 — VEHICLE UPGRADES (5)
            # ══════════════════════════════════════════════════════════════════════
            "Tire Ready Kit": {
                "ingredients": ["Spare Tire", "Car Jack"],
                "description": "Pre-assembled tire change. Car events: instant flat fix.",
                "pawn_value": 60,
                "category": "vehicle",
                "craft_text": "You pre-mount the spare and rig the jack to a bracket on the frame. The first test: you lift the car in 45 seconds. The second test: you drop the car because the bracket slipped. The third test: you add more bolts. It holds. Your mechanic would cry if she saw this. Tears of pride or horror, unclear.",
                "hint_vague": "Flat tires fear preparation.",
                "hint_suggestive": "A vehicle upgrade. Spare rubber meets lifting power.",
                "tier": 1,
            },
            "Power Grid": {
                "ingredients": ["Jumper Cables", "Spare Fuses"],
                "description": "Electrical backup. Car: prevent all electrical failures.",
                "pawn_value": 40,
                "category": "vehicle",
                "craft_text": "Jumper cables wired to the fuse panel through a distribution block you made from a lunchbox. It looks like a bomb. It is not a bomb. You label it \"NOT A BOMB\" in Sharpie. This does not help. But it will jumpstart your car, stabilize the voltage, and run a camp light, so aesthetic concerns are secondary.",
                "hint_vague": "Jump-start everything at once.",
                "hint_suggestive": "A vehicle upgrade. Cable power meets fuse protection.",
                "tier": 1,
            },
            "Miracle Lube": {
                "ingredients": ["Motor Oil", "WD-40"],
                "description": "Universal lubricant. Car: prevent seizure/rust/squeaks.",
                "pawn_value": 35,
                "category": "vehicle",
                "craft_text": "Motor oil and WD-40 in a squeeze bottle. You shake it. The mixture turns a color that doesn't exist in nature. You squeeze a drop onto the workbench hinge. The hinge, which has never been silent in its life, makes zero sound. You squeeze a drop on your shoe. Your shoe becomes frictionless. You need to be careful with this stuff.",
                "hint_vague": "Squeaks, groans, and resistance — silenced.",
                "hint_suggestive": "A vehicle upgrade. Two lubricants become one.",
                "tier": 1,
            },
            "Mobile Workshop": {
                "ingredients": ["Tool Kit", "Duct Tape"],
                "description": "Portable repair. Car events: fix any problem on-site.",
                "pawn_value": 60,
                "category": "vehicle",
                "craft_text": "Tools strapped to duct tape rolls in a canvas bag. Wrench here, pliers there, socket set held together with ATTITUDE. You organize everything by \"frequency of panic use.\" The most-grabbed tool is on top. It's the duct tape. It's always the duct tape.",
                "hint_vague": "Fix anything, anywhere.",
                "hint_suggestive": "A vehicle upgrade. Full toolkit meets quick fixes.",
                "tier": 1,
            },
            "Pursuit Package": {
                "ingredients": ["Dog Whistle", "Running Shoes"],
                "description": "Chase deterrent. Dark: outrun + dog distraction.",
                "pawn_value": 40,
                "category": "vehicle",
                "craft_text": "Dog whistle taped to a lanyard. Running shoes laced tight. You test the whistle — no audible sound but three dogs within earshot go BERSERK. You test the shoes — fast. Too fast? No. Just fast ENOUGH for a person who may need to chase or be chased at any moment. That's your life now. Running shoes and a dog whistle. Don't think about it too hard.",
                "hint_vague": "Catch anything on four legs.",
                "hint_suggestive": "A vehicle upgrade. Calling meets chasing.",
                "tier": 1,
            },

            # ══════════════════════════════════════════════════════════════════════
            # TIER 2 — COMBINATION CRAFTS (25)
            # ══════════════════════════════════════════════════════════════════════
            "Assassin's Kit": {
                "ingredients": ["Shiv", "Pepper Spray"],
                "description": "Close + ranged combat. Dark: auto-win violence, no damage taken.",
                "pawn_value": 80,
                "category": "weapon",
                "craft_text": "You strap the pepper spray to the shiv handle. The blade catches the light. The spray nozzle points forward. One weapon, two damage types. You test the grip. It feels natural. TOO natural. You set it down and stare at your hands like they belong to someone else. Where did you LEARN this?",
                "tier": 2,
            },
            "Fire Launcher": {
                "ingredients": ["Slingshot", "Road Flare Torch"],
                "description": "Ranged incendiary. Night: clear threats. Adventures: boss damage.",
                "pawn_value": 75,
                "category": "weapon",
                "craft_text": "Load the road flare into the slingshot. Pull back. It launches. It hits a dumpster. The dumpster is on fire. You didn't mean to hit the dumpster. You were aiming at the GROUND. The range on this thing is... concerning. You make three more projectiles and suddenly you're an artillery battery.",
                "tier": 2,
            },
            "Tear Gas": {
                "ingredients": ["Pepper Spray", "Stink Bomb"],
                "description": "Room-clearing chemical. Dark: incapacitate all hostiles.",
                "pawn_value": 50,
                "category": "weapon",
                "craft_text": "Pepper spray meets stink bomb chemistry and the result is EVIL. Your eyes water through the sealed container. A passing bird changes direction mid-flight. You've created a Geneva Convention violation in a sandwich bag. You're not proud. But you're prepared.",
                "tier": 2,
            },
            "Street Fighter Set": {
                "ingredients": ["Shiv", "Brass Knuckles"],
                "description": "Full melee arsenal. Dark: reputation dangerous, skip violence.",
                "pawn_value": 100,
                "category": "weapon",
                "craft_text": "Shiv in the left hand. Brass knuckles on the right. You shadowbox the air. Left jab cuts, right hook breaks. You look ridiculous. You feel dangerous. These two feelings are not mutually exclusive. A pedestrian watches you punch air for thirty seconds and decides to cross the street.",
                "tier": 2,
            },
            "Survival Bivouac": {
                "ingredients": ["Emergency Blanket", "Fire Starter Kit"],
                "description": "Complete shelter. Night/survival: cold immunity, skip weather.",
                "pawn_value": 40,
                "category": "survival",
                "craft_text": "Emergency blanket draped over the fire starter kit setup. You crawl in. It's warm. It's dry. It smells like aluminum and hope. You were going to test it for five minutes but you fell asleep for forty. When you woke up, it was raining and you were dry. This thing works better than your apartment.",
                "tier": 2,
            },
            "Hydration Station": {
                "ingredients": ["Water Purifier", "Rain Collector"],
                "description": "Clean water forever. Illness: waterborne immunity.",
                "pawn_value": 35,
                "category": "survival",
                "craft_text": "Water purifier hose runs into the rain collector basin. The first test collects morning dew and filters it into the purest water you've ever tasted. You drink it. You fill a bottle. You drink that too. You've been dehydrated for three days and didn't know it. This machine just saved your life and it's made of a tarp.",
                "tier": 2,
            },
            "Provider's Kit": {
                "ingredients": ["Snare Trap", "Fishing Rod"],
                "description": "Food independence. Survival: food shortage becomes surplus.",
                "pawn_value": 50,
                "category": "survival",
                "craft_text": "Snare trap rigged next to the fishing rod in a carrying case. Land food. Sea food. All food. You bait both and wait. Two hours later: a rabbit in the trap and a bass on the line. You're eating like a man with a plan for the first time in weeks. The rod broke during retrieval. You fixed it with the trap's spare wire. This is who you are now.",
                "tier": 2,
            },
            "Fortified Perimeter": {
                "ingredients": ["Improvised Trap", "Car Alarm Rigging"],
                "description": "Multi-layer defense. Night: no theft/intrusion/surprises.",
                "pawn_value": 55,
                "category": "survival",
                "craft_text": "Car alarm rigging wired to improvised trip-wire traps in a 50-foot radius. The first test triggers when a CAT walks through. The alarm screams. The trap pops. The cat is fine but deeply offended. Calibration complete. No cat, dog, human, or cryptid is getting within 50 feet without you knowing.",
                "tier": 2,
            },
            "All-Weather Armor": {
                "ingredients": ["Storm Suit", "Outdoor Shield"],
                "description": "ALL environmental immunity. Heat/cold/rain/sun/insects/chemicals.",
                "pawn_value": 45,
                "category": "survival",
                "craft_text": "Storm suit over outdoor shield application. You look like a HAZMAT worker who's also prepared for a beach vacation. You step outside during a thunderstorm to test it. Rain bounces off. Wind pushes and you don't budge. Lightning flashes and you realize you're standing in a field during a thunderstorm to prove a point. Priorities.",
                "tier": 2,
            },
            "Master Key": {
                "ingredients": ["Lockpick Set", "Security Bypass"],
                "description": "Open literally anything. Adventures: hidden room access.",
                "pawn_value": 80,
                "category": "tool",
                "craft_text": "Lockpick set integrated with security bypass tools into a single roll-up case. You test it on the workbench padlock. Open in four seconds. You test it on your car door. Three seconds. You test it on the gas station bathroom. Two seconds. You test it on the manager's office. He's inside. You apologize and close the door.",
                "tier": 2,
            },
            "Night Scope": {
                "ingredients": ["Binocular Scope", "Headlamp"],
                "description": "See everything dark. Night: no surprise, full awareness.",
                "pawn_value": 65,
                "category": "tool",
                "craft_text": "Headlamp focused through the binocular scope. The result turns 2am into noon with terrifying clarity. You can see the license plate on a car 200 yards away, in the dark. You can see a raccoon's FACIAL EXPRESSION at 100 yards. It looks guilty. You're going to see things you don't want to see. That's the cost of clarity.",
                "tier": 2,
            },
            "SOS Kit": {
                "ingredients": ["Signal Mirror", "Smoke Flare"],
                "description": "Ultimate rescue signal. Any peril: guaranteed rescue.",
                "pawn_value": 30,
                "category": "tool",
                "craft_text": "Signal mirror angled into the smoke flare launcher. Day or night, you can be found. The test launch sends smoke 200 feet up and the mirror catches it from a mile away. A helicopter pilot three counties over radios that he sees \"some kind of distress signal.\" You wave them off. It was a test. They're not happy. But they found you — in eleven minutes.",
                "tier": 2,
            },
            "Intelligence Dossier": {
                "ingredients": ["Evidence Kit", "Forged Documents"],
                "description": "Leverage on everyone. People/casino: know secrets/house edge.",
                "pawn_value": 100,
                "category": "tool",
                "craft_text": "Evidence kit records. Forged documents create cover. Together they form a dossier that could fool the CIA. You write a practice entry about yourself. Full background check, credit history, criminal record. All fake. All flawless. You read it and feel sad. This fictional version of you has better credit.",
                "tier": 2,
            },
            "Surveillance Suite": {
                "ingredients": ["Spotlight", "Radio Jammer"],
                "description": "Counter-intelligence. Wealth: ALL tracking blocked.",
                "pawn_value": 90,
                "category": "tool",
                "craft_text": "Spotlight angled for scanning. Radio jammer set to block. You test it in the gas station parking lot. The spotlight catches every movement within 200 yards. The jammer kills every phone signal in the area. The gas station attendant comes out: \"My phone's dead.\" Yours too. Friendly fire. Adjust the range.",
                "tier": 2,
            },
            "Mind Shield": {
                "ingredients": ["Dream Catcher", "Worry Stone"],
                "description": "Mental defense. Sanity loss -50%. Nightmares impossible.",
                "pawn_value": 30,
                "category": "charm",
                "craft_text": "Dream catcher woven around worry stone, tied with a leather cord. You hold it. The anxiety in your chest — the one you forgot was always there — goes quiet. Not gone. Just quiet. Like it's behind a wall. You can still hear it, but distantly. You put the Mind Shield under your pillow. You sleep better than you have in weeks. What was the anxiety about? You can't remember. Good.",
                "tier": 2,
            },
            "Fortune's Favor": {
                "ingredients": ["Lucky Charm Bracelet", "Luck Totem"],
                "description": "Stacked luck. Passive: +10% all random chances.",
                "pawn_value": 200,
                "category": "charm",
                "craft_text": "Two lucky charms, bound with copper wire. The moment the wire closes the circuit, every coin in your pocket lands heads-up. You checked. The lotto ticket in your wallet — you scratch it. $5 winner. Coincidence? The second scratch: $10. The third: nothing. Even luck has limits. But the limits just moved.",
                "tier": 2,
            },
            "Fate Reader": {
                "ingredients": ["Lucky Charm Bracelet", "Fortune Cards"],
                "description": "Foresight + luck. Surreal: always choose right. Consumed after 5.",
                "pawn_value": 50,
                "category": "charm",
                "craft_text": "Lucky bracelet threaded through the fortune card deck. The cards deal themselves. Three. They land face up: Past, Present, Future. The Past card shows a room you recognize. The Present card shows this workbench. The Future card is blank. Then it's not. But what it shows — no. That can't be right. ...Can it?",
                "tier": 2,
            },
            "Lucid Dreaming Kit": {
                "ingredients": ["Dream Catcher", "Eldritch Candle"],
                "description": "Dream control. Choose content. Always positive sleep.",
                "pawn_value": 80,
                "category": "charm",
                "craft_text": "Eldritch candle placed in the center of the dream catcher. The green flame passes through the web strings without burning them. The strings GLOW. The whole thing hums at a frequency you feel in your teeth. You set it on your nightstand. That night, for the first time, the dream asks for YOUR permission.",
                "tier": 2,
            },
            "Old Money Identity": {
                "ingredients": ["Gentleman's Charm", "Heirloom Set"],
                "description": "Wealthy aristocrat disguise. Wealth: billionaire treatment.",
                "pawn_value": 500,
                "category": "disguise",
                "craft_text": "Gentleman's charm combined with the heirloom set. You button the cuffs. Adjust the watch. Dab the cologne. Check the mirror. Staring back at you is a man who went to prep school and summers in Martha's Vineyard. He has opinions about wine. He played lacrosse. He's YOU. But also: not you. You're terrified of how easy this was.",
                "tier": 2,
            },
            "New Identity": {
                "ingredients": ["Low-Profile Outfit", "Forged Documents"],
                "description": "Complete alias. Police unfindable. Casino fresh start.",
                "pawn_value": 100,
                "category": "disguise",
                "craft_text": "Low-profile outfit. Forged documents. You put it on. Open the passport. Look at the mirror. The name says Michael Torres. The face says nobody. You test it — walk into a diner where they KNOW you. The waitress says \"What can I get you?\" No recognition. None. The old you just... stopped. You order coffee as Michael. It tastes different.",
                "tier": 2,
            },
            "Beast Tamer Kit": {
                "ingredients": ["Animal Bait", "Pet Toy"],
                "description": "Animal handling mastery. Always befriend, never attacked.",
                "pawn_value": 30,
                "category": "companion",
                "craft_text": "Animal bait and pet toy bundled together. You test it by setting it in the grass. Within five minutes: a squirrel, two birds, a stray cat, and something that might be a ferret? They line up. Orderly. Like students. The cat swats the squirrel. You say \"No.\" The cat stops. WHY did the cat stop? You say \"Sit.\" They sit. All of them. You're a Disney princess now.",
                "tier": 2,
            },
            "Cheater's Insurance": {
                "ingredients": ["Devil's Deck", "Evidence Kit"],
                "description": "Cheat risk-free at gambling. Casino: never caught.",
                "pawn_value": 60,
                "category": "dark_arts",
                "craft_text": "Devil's deck paired with evidence kit. One cheats. The other covers. You test it at a solo card game. You win. Obviously. Then you photograph the winning hand, the card order, the shuffle pattern. The evidence looks like proof of FAIR play. You just documented your own cheat as honest. This is the most ethically bankrupt thing you've ever built. It's also the most useful.",
                "tier": 2,
            },
            "Roadside Shield": {
                "ingredients": ["Tire Ready Kit", "Power Grid"],
                "description": "Combined fixes. Car: prevent 60% of troubles.",
                "pawn_value": 100,
                "category": "vehicle",
                "craft_text": "Tire ready kit mounted next to power grid, all in the trunk. Pre-wired, pre-jacked, pre-everything. You simulate a breakdown. Flat tire AND dead battery simultaneously. Fixed in under five minutes. The car starts. The tire holds. You feel invincible. A car drives past and the driver waves, assuming you're a roadside mechanic. You almost believe it yourself.",
                "tier": 2,
            },
            "Auto Mechanic": {
                "ingredients": ["Mobile Workshop", "Miracle Lube"],
                "description": "80% car trouble prevention + instant fix.",
                "pawn_value": 120,
                "category": "vehicle",
                "craft_text": "Mobile workshop opened, miracle lube loaded. Full diagnostic: pop the hood, feel the belts, check the fluid, listen to the engine. Your car makes a sound at 2000 RPM you've never heard. You apply lube. The sound stops. You apply more lube. The engine PURRS. It hasn't purred since the dealership. You scratch the dashboard. \"Good car.\" You just talked to your car. The car said nothing back. Obviously. ...Obviously.",
                "tier": 2,
            },
            "Rolling Fortress": {
                "ingredients": ["Pursuit Package", "Fortified Perimeter"],
                "description": "Mobile bunker. Theft immunity. Chase escape.",
                "pawn_value": 110,
                "category": "vehicle",
                "craft_text": "Pursuit package strapped to the roof. Fortified perimeter wired to the chassis. Alarms on every door. Traps under the bumper. You test the alarm — a passing jogger triggers it from 30 feet. The traps deploy — a trash bag trips the line. The jogger screams. The trash bag is neutralized. You apologize to the jogger and spend ten minutes adjusting the sensitivity. Your car is now a bunker that goes 60 MPH. Mad Max would cry.",
                "tier": 2,
            },

            # ══════════════════════════════════════════════════════════════════════
            # TIER 3 — MASTERWORKS (12, 3 ingredients each)
            # ══════════════════════════════════════════════════════════════════════
            "Road Warrior Armor": {
                "ingredients": ["Assassin's Kit", "Scrap Armor", "Street Fighter Set"],
                "description": "Full combat. Physical damage nullified. Dark auto-win.",
                "pawn_value": 300,
                "category": "legendary",
                "craft_text": "Three weapons fused into a harness of steel, spray, and flame. You strap it on. It's heavy. It's terrifying. You look at yourself in the car window and the person staring back is someone you don't entirely recognize. They look like they've been through something. You HAVE been through something. This armor is proof.",
                "tier": 3,
            },
            "Third Eye": {
                "ingredients": ["Mind Shield", "Lucid Dreaming Kit", "Fortune Cards"],
                "description": "See outcomes before choosing. Dreams controlled. Min sanity 50.",
                "pawn_value": 200,
                "category": "legendary",
                "craft_text": "Mind shield, dream kit, and fate reader merge into a headband that HUMS. You put it on. The world looks the same. Then it doesn't. You see a shimmer around things — people, cars, doors — like heat haze. The shimmer around the next event is brighter than the rest. You know what happens tomorrow. You don't know how you know. The headband is warm.",
                "tier": 3,
            },
            "Nomad's Camp": {
                "ingredients": ["Survival Bivouac", "Provider's Kit", "Hydration Station"],
                "description": "Self-sufficient. No survival event harms. All necessities covered.",
                "pawn_value": 150,
                "category": "legendary",
                "craft_text": "Bivouac. Provider's kit. Hydration station. All assembled, tested, deployed. You could live here. Not \"survive\" — LIVE. Shelter, food, water, warmth. You sit in the camp and for the first time, nothing is wrong. The silence is comfortable. The world could end tomorrow. You'd barely notice. You'd eat breakfast and watch the sunrise.",
                "tier": 3,
            },
            "All-Access Pass": {
                "ingredients": ["Master Key", "Night Scope", "Intelligence Dossier"],
                "description": "Know everything, access everywhere. All secrets/locks/hidden rooms.",
                "pawn_value": 350,
                "category": "legendary",
                "craft_text": "Master key, night scope, intelligence dossier. You hold all three and something shifts. Every locked door, dark hallway, and hidden password becomes trivial. The world has guardrails and you just found the staff entrance. The night scope shows you secrets. The key lets you in. The dossier tells you why it matters. You are the most informed lock-picker in human history.",
                "tier": 3,
            },
            "Master of Games": {
                "ingredients": ["Old Money Identity", "Cheater's Insurance", "Enchanted Vintage"],
                "description": "Casino/social perfection. All events favor you. Elegance always.",
                "pawn_value": 800,
                "category": "legendary",
                "craft_text": "Old money identity. Cheater's insurance. Enchanted vintage. You put together the ultimate con artist starter pack and feel your soul leave your body for just a second. You could buy a casino with borrowed money and a smile. You could out-bluff the devil. You could sell sand to a desert. You don't want to know what kind of person you are for building this. But it's built.",
                "tier": 3,
            },
            "Immortal Vehicle": {
                "ingredients": ["Auto Mechanic", "Rolling Fortress", "Roadside Shield"],
                "description": "Never breaks/stolen. Self-repairs overnight. No trouble events.",
                "pawn_value": 500,
                "category": "legendary",
                "craft_text": "Auto mechanic. Rolling fortress. Roadside shield. The merge takes two hours and when it's done, your car is more machine than machine. Self-diagnosing. Self-defending. Self-repairing, almost. You turn the key and the car starts before you finish the motion. It KNEW. \"Ready,\" you say to no one. The dashboard lights blink twice.",
                "tier": 3,
            },
            "Gambler's Aura": {
                "ingredients": ["Fortune's Favor", "Luck Totem", "Smelling Salts"],
                "description": "+15% random chances. Blackjack always favorable.",
                "pawn_value": 400,
                "category": "legendary",
                "craft_text": "Three layers of luck, braided and bound. The totem, the favor, the bracelet. You hold the finished aura against your chest. Your heart skips a beat. Then the coin on the ground catches your eye. Then the scratch ticket in the gutter. Then the $20 in the drain. It's already working. The universe has noticed you and it's embarrassed about everything it owes.",
                "tier": 3,
            },
            "Ark Master's Horn": {
                "ingredients": ["Beast Tamer Kit", "Animal Bait", "Feeding Station"],
                "description": "Command all animals. Companions never leave. All events positive.",
                "pawn_value": 250,
                "category": "legendary",
                "craft_text": "Beast tamer kit. Hydration station. Animal bait. The horn is just a rolled-up cone of tin, but when you blow it, every bird within earshot changes direction. Toward you. Dogs sit. Cats appear from nowhere. A fish jumps. Out of water. INTO YOUR HANDS. You are the Ark. The animals chose you.",
                "tier": 3,
            },
            "Guardian Angel": {
                "ingredients": ["SOS Kit", "Distress Beacon", "Fortified Perimeter"],
                "description": "Cannot die. Lethal damage becomes non-lethal. One self-revive.",
                "pawn_value": 300,
                "category": "legendary",
                "craft_text": "SOS kit. Distress beacon. Fortified perimeter. All synchronized. Triple redundancy: if one system fails, two others catch you. You test all three simultaneously and three different emergency services respond. Again: you have to wave them off. But the response time? Under eight minutes. From three directions. Nothing can reach you that help can't reach faster.",
                "tier": 3,
            },
            "Hazmat Suit": {
                "ingredients": ["Gas Mask", "All-Weather Armor", "Storm Suit"],
                "description": "ALL environmental/chemical/weather immunity.",
                "pawn_value": 150,
                "category": "legendary",
                "craft_text": "Gas mask over all-weather armor over storm suit components. Full coverage. You seal the last seam and realize you've built something that could walk through a chemical plant explosion. You put it on and your own breathing sounds like Darth Vader. Every step is a heavy thud. You are invulnerable to weather, gas, acid, and social interaction. Nobody talks to the hazmat guy.",
                "tier": 3,
            },
            "Ghost Protocol": {
                "ingredients": ["Surveillance Suite", "New Identity", "Radio Jammer"],
                "description": "Invisible to tracking. Nobody knows you. Zero surveillance.",
                "pawn_value": 400,
                "category": "legendary",
                "craft_text": "Surveillance suite. New identity. Mind shield. The ghost protocol doesn't make you invisible — it makes you IRRELEVANT. Cameras don't focus on you. Dogs don't bark. NPCs' eyes slide past you like you're furniture. You test it by standing in the middle of a crowded parking lot. Nobody looks. Nobody acknowledges. For five minutes, you don't exist. It's peaceful. Then it's terrifying. You take it off.",
                "tier": 3,
            },
            "Dark Pact Reliquary": {
                "ingredients": ["Eldritch Candle", "Binding Portrait", "Devil's Deck"],
                "description": "Master dark powers. Devil deals favor you. -3 sanity/day.",
                "pawn_value": 200,
                "category": "legendary",
                "craft_text": "Eldritch candle. Binding portrait. Devil's deck. They merge and the temperature drops five degrees. The reliquary whispers. Not words — ALMOST words. Like someone speaking through a wall. The candle lights itself. The portrait's eyes move. The cards shuffle continuously, even sealed. You set it in your bag and the bag hums. The reliquary knows your name. You never told it.",
                "tier": 3,
            },

            # ══════════════════════════════════════════════════════════════════════
            # TIER 4 — LEGENDARY (11, crafted + rare event drop)
            # ══════════════════════════════════════════════════════════════════════
            "Beastslayer Mantle": {
                "ingredients": ["Road Warrior Armor", "Gator Tooth Necklace"],
                "description": "All violence/animal immunity. Physical invincibility.",
                "pawn_value": 1000,
                "category": "legendary",
                "craft_text": "Gator tooth bonds to the road warrior armor. It shouldn't fit. It does. The tooth finds its place like it was always missing from the armor. When you put it on, you don't feel human. You feel like something that hunts humans. Every predator instinct you didn't know you had wakes up at once. A bird of prey circles overhead. Respect? Recognition? You nod at it. It nods back. No it doesn't. ...Does it?",
                "tier": 4,
            },
            "Seer's Chronicle": {
                "ingredients": ["Third Eye", "Hermit's Journal"],
                "description": "Know every event 10 days ahead. Perfect foresight.",
                "pawn_value": 1000,
                "category": "legendary",
                "craft_text": "The old journal's pages merge with the Third Eye's vision. Your handwriting appears on blank pages — but you're not writing. The chronicle IS writing. It describes tomorrow. Then the day after. Then next week. You try to read ahead. The pages go blank. \"You're not ready for that yet,\" the chronicle seems to say. Not in words. In empty pages.",
                "tier": 4,
            },
            "Wanderer's Rest": {
                "ingredients": ["Nomad's Camp", "Carved Walking Stick"],
                "description": "Self-sufficient + nature heals. +10 HP/day passive.",
                "pawn_value": 800,
                "category": "legendary",
                "craft_text": "Walking stick planted. Nomad's camp deployed around it. Roots grow. Actually grow. From the stick. Into the dirt. In an hour, the camp has a living fence of vines that weren't there before. This isn't a camp anymore. It's a garden that showed up uninvited. You water the roots. The garden grows a tomato. ONE tomato. It's perfect.",
                "tier": 4,
            },
            "Skeleton Key": {
                "ingredients": ["All-Access Pass", "Night Vision Scope"],
                "description": "Unlock ANYTHING. All hidden content access.",
                "pawn_value": 1500,
                "category": "legendary",
                "craft_text": "All-Access Pass merges with the night scope. The key doesn't look like a key — it looks like UNDERSTANDING. You hold it near a door. The door's lock EXPLAINS itself to you. Tumblers, mechanism, intent. Why it was locked. What it's protecting. You could open it. Should you? The key doesn't judge. The key just knows.",
                "tier": 4,
            },
            "King of the Road": {
                "ingredients": ["Master of Games", "Junkyard Crown"],
                "description": "All NPCs defer. All games favor. +$1000/day passive.",
                "pawn_value": 2000,
                "category": "legendary",
                "craft_text": "The crown settles. You didn't make a crown — you made the Master of Games, and when you put it on, something in the world shifts. People notice you. Not your clothes, not your face — your GRAVITY. You walk into a room and conversations pause. You sit at a table and the dealer straightens up. Authority isn't earned or stolen. It's WORN. And it fits you terrifyingly well.",
                "tier": 4,
            },
            "War Wagon": {
                "ingredients": ["Immortal Vehicle", "Artisan's Toolkit"],
                "description": "Mobile fortress. Self-repair, storage, combat.",
                "pawn_value": 1800,
                "category": "legendary",
                "craft_text": "Artisan toolkit welds to the Immortal Vehicle. The car twitches. TWITCHES. Like a reflex. The dashboard lights cycle through a sequence you didn't program. The steering wheel adjusts itself to your hand size. The engine runs without the key. Your car isn't just fixed — it's AWAKE. You're not sure it sleeps anymore. When you park at night, you hear the engine humming. Softly. Like breathing.",
                "tier": 4,
            },
            "Moonlit Fortune": {
                "ingredients": ["Gambler's Aura", "Moon Shard"],
                "description": "Permanent +20% blackjack. Luck bends to will.",
                "pawn_value": 2000,
                "category": "legendary",
                "craft_text": "Moon shard meets gambler's aura. The fusion happens at exactly midnight. Not approximately — exactly. The moon shard glows, the aura absorbs it, and luck becomes physics. Coins land how you want. Dice roll how you need. Cards fall where they should. It's not cheating. It's the universe paying a debt it didn't know it owed. Permanent luck. PERMANENT. The blackjack table is your kingdom. The math changed.",
                "tier": 4,
            },
            "Leviathan's Call": {
                "ingredients": ["Ark Master's Horn", "Kraken Pearl"],
                "description": "Command sea/land creatures. Recruitment events.",
                "pawn_value": 1500,
                "category": "legendary",
                "craft_text": "Pearl meets the Ark Master's Horn. The pearl vibrates when you hold it near water. Any water. A puddle. A glass. A tear. The horn amplifies it into a call that travels through water, soil, and something else. You blow the horn by the river. The water stills. Then ripples. Something just acknowledged you from very, very deep down. The fish surface — not summoned. ATTENDING.",
                "tier": 4,
            },
            "Last Breath Locket": {
                "ingredients": ["Guardian Angel", "Phoenix Feather"],
                "description": "TRUE immortality. HP cannot reach 0.",
                "pawn_value": 5000,
                "category": "legendary",
                "craft_text": "Phoenix feather ignites inside the Guardian Angel's locket. The flame doesn't consume it — it LIVES inside, circling the chamber like a caged sun. You clasp it shut. Warm against your chest. Your heartbeat syncs with the flame. For one second, your heart stops. Then it starts again. Stronger. The locket didn't save your life. It CLAIMED it. Death has to go through the locket first now. And the locket doesn't open for anyone.",
                "tier": 4,
            },
            "Phantom Rose": {
                "ingredients": ["Ghost Protocol", "Scrap Metal Rose"],
                "description": "Legend status. +$500/day. Zero negative recognition.",
                "pawn_value": 2500,
                "category": "legendary",
                "craft_text": "Metal rose inserted into the Ghost Protocol casing. The rose blooms. A metal flower, blooming. The petals open and inside: a mirror so small it fits in your palm. In the mirror: a hallway. You can't identify it but you've been there. That's the place between being seen and not being seen. You're a legend now. A story. A whisper that walks through walls. People who look for you will find only the rose's scent.",
                "tier": 4,
            },
            "Soul Forge": {
                "ingredients": ["Dark Pact Reliquary", "Ritual Token"],
                "description": "Rewrite ANY past event. One-time use.",
                "pawn_value": 3000,
                "category": "legendary",
    ...
    def make_crafted_item_descriptions(self):
        ...
        return {
            ...
            # TIER 1 — GADGETS
            # ══════════════════════════════════════════════════════════════════════
            "Headlamp": "Hands-free flashlight strapped to your head with industrial tape. Night events reveal threats one turn earlier. +15% awareness in darkness. You look ridiculous but you can SEE.",
            "Spotlight": "Focused long-range beam made from a flashlight and binoculars. Reveals hidden paths during adventures. Can't be used subtly — everything you point at is bathed in airport-runway brightness.",
            "Evidence Kit": "Camera/transmitter combo for documenting incriminating events. Dark events: leverage over NPCs. Can photograph crimes in progress and transmit the evidence somewhere. You're not sure where. Guatemala, maybe.",
            "Radio Jammer": "Blocks all electronic signals in a 30-foot radius. Casino events: surveillance goes blind. Wealth events: blocks tracking. Also blocks YOUR phone, which you forget every time.",
            "EMP Device": "Short-circuits electronics in a 20-foot blast. Disables security systems, cameras, and electronic locks. Single use. WARNING: also disables anything of yours within range. Plan accordingly.",
            "Distress Beacon": "Supercharged emergency signal with three-county range. Survival events: guaranteed rescue within minutes. Use sparingly — emergency services get annoyed after the third false alarm.",
            "Security Bypass": "Lockpick/tension wrench combo from a disassembled padlock. Opens or locks anything mechanical. Adventures: access restricted areas. Works on doors, padlocks, handcuffs, and at least one vending machine.",

            # ══════════════════════════════════════════════════════════════════════
            # TIER 1 — DISGUISES
            # ══════════════════════════════════════════════════════════════════════
            "Low-Profile Outfit": "Sunglasses under a poncho hood. You become aggressively unremarkable. People events: avoid recognition. NPCs who've met you won't recognize you. NPCs who haven't will immediately forget you.",
            "Beach Bum Disguise": "Thick sunscreen streaks and angled shades. You look like a tourist who gave up. Dark events: muggers ignore tourists — no profit margin. You're too pathetic to rob.",
            "Gas Mask": "Sealed welding goggles with air freshener filters. Breathe through chemical spills, gas attacks, and Stink Bomb aftermath. Smells like a car dealership. Survival: full chemical/gas immunity.",
            "Storm Suit": "Umbrella-framed poncho armor. Full rain/wind/cold protection. You look like a walking tent. Weather events cannot harm you. Dignity? That was already gone.",
            "Brass Knuckles": "Padlock wedged between leather glove fingers. Hidden weapon that hits like a parking meter. Dark events: auto-win fistfights. The handshake is the warning.",
            "Gentleman's Charm": "Cologne-scented silk handkerchief. Creates an aura of unearned sophistication. People events: NPCs trust you instinctively. +30% persuasion. You smell like someone who has their life together.",
            "Forged Documents": "Fake identity papers with a ballpoint government seal. Law events: avoid arrest. VIP access to restricted locations. The photo doesn't quite match but the confidence does.",

            # ══════════════════════════════════════════════════════════════════════
            # TIER 1 — TONICS & CONSUMABLES
            # ══════════════════════════════════════════════════════════════════════
            "Antacid Brew": "Baking soda and water. Grandma's cure for everything below the ribcage. Illness events: cures food poisoning/nausea instantly. Single use. Tastes like regret and relief.",
            "Trail Mix Bomb": "Birdseed packed around matches in a napkin. Distraction device. Dark events: throw to create chaos — seeds draw birds, matches flash. Escape guaranteed. Pigeons are complicit.",
            "Animal Bait": "Dog treats and birdseed in a ziplock bag. Animal events: attracts creatures for companion recruitment. Open with caution — the interest is IMMEDIATE and ENTHUSIASTIC.",
            "Stink Bomb": "Tuna juice and baking soda in a sealed jar. Area denial weapon. Dark events: force all NPCs to evacuate. The Geneva Convention doesn't cover this. Single use. Your eyes will water through the jar.",
            "Voice Soother": "Cough drop and mint solution. Voice drops half an octave and smooths like jazz. People events: +20% persuasion. You'll want to practice saying \"Good evening\" to no one.",
            "Outdoor Shield": "Sunscreen/bug spray blend. One application and the outdoors surrenders. Survival: blocks sunburn AND insects. Mosquitoes approach, reconsider their life choices, and leave.",
            "Cool Down Kit": "Premium sunscreen mixed with cold water. Heat protection: prevents heat stroke. Reusable. It's a cold thing that protects you from hot things. Not every invention needs to be complicated.",
            "Smoke Flare": "Matches in a sealed garbage bag. Ignite for thick, angry smoke visible for miles. Survival: attract rescue. You will also lose visibility. And breathing. But you'll be FOUND.",
            "Vermin Bomb": "Pest control powder + baking soda accelerant. Nuclear option for pest infestations. Car events: eliminate all vermin problems. Also eliminates the structural integrity of sealed cups.",

            # ══════════════════════════════════════════════════════════════════════
            # TIER 1 — DARK ARTS
            # ══════════════════════════════════════════════════════════════════════
            "Eldritch Candle": "Necronomicon pages wrapped around wax. The flame is green. You didn't light it. Dark events: entities obey simple commands. Costs 2 sanity per use. The candle relights itself. Don't ask questions you don't want answered.",
            "Binding Portrait": "Cursed ink on a photograph. The subject blinks. People events: blackmail leverage over anyone whose likeness you capture. Keep it face-down. It watches.",
            "Blackmail Letter": "Elegant threats on mysterious stationery. Wealth events: extort NPCs for cash. Your handwriting is terrible but consistently terrible, which reads as official.",
            "Devil's Deck": "Cards passed through cursed flame. The face cards look at you. Casino events: cheat any card game. The jokers grin wider than they were printed. You try not to notice.",
            "Fortune Cards": "Lucky penny glued to the ace of spades. The deck shuffles itself. Surreal events: predict/avoid outcomes. Draw three to see Past, Present, and Future. The Future card is usually blank. Usually.",

            # ══════════════════════════════════════════════════════════════════════
            # TIER 1 — LUXURY
            # ══════════════════════════════════════════════════════════════════════
            "Kingpin Look": "Gold chain + cigars = crime boss aesthetic. Dark events: criminals respect you on sight. You look like a man who owns things. You own a workbench. They don't know that.",
            "Enchanted Vintage": "Wine in a silver flask that somehow tastes transcendentally better. Social events: infinite toasting. Never runs empty. Stop testing it. You're drinking your inventory.",
            "Heirloom Set": "Antique watch + fancy pen with fake initials. Looks inherited from a rich grandfather you never had. People events: old money treatment. Everyone assumes you summer somewhere expensive.",
            "Aristocrat's Touch": "Leather gloves + silk pocket square. Noble hands that command hard rooms. People events: handshake seals any deal. The silk adjustment takes effort to look effortless.",
            "Power Move Kit": "Monogrammed lighter + fine cigars. The snap-light-lean-back combo. Business events: instant intimidation, better deals. You've become the person at the party.",
            "Animal Magnetism": "Cologne-infused leather gloves. Irresistible presence in handshake form. People events: strangers give you gifts/offers. Dangerously effective. You convinced yourself you're a good person, just from a handshake.",
            "Luck Totem": "Rabbit foot tied to a lucky penny. Swings northwest like a compass toward something lucky. Passive: +5% all random rolls. Double the luck, double the superstition.",

            # ══════════════════════════════════════════════════════════════════════
            # TIER 1 — VEHICLE
            # ══════════════════════════════════════════════════════════════════════
            "Tire Ready Kit": "Pre-assembled tire change. Spare mounted, jack rigged, bolts added after the first drop. Car events: instant flat tire fix. Your mechanic would cry. Tears of pride or horror, unclear.",
            "Power Grid": "Jumper cables wired through a lunchbox distribution block. It looks like a bomb. It is NOT a bomb. It says so in Sharpie. Car events: prevent all electrical failures.",
            "Miracle Lube": "Motor oil + WD-40. The mixture turns a color that doesn't exist in nature. Car: prevents seizure/rust/squeaks. One drop made a hinge silent for the first time in its life. Be careful with this stuff.",
            "Mobile Workshop": "Toolkit organized by 'frequency of panic use.' The most-grabbed tool is on top. It's the duct tape. Car events: fix any problem on-site. Fix anything, anywhere.",
            "Pursuit Package": "Dog whistle + running shoes. Chase deterrent: outrun threats + dog distraction. Three dogs within earshot went BERSERK on the first test. That's your life now.",

            # ══════════════════════════════════════════════════════════════════════
            # TIER 2 — COMBINATIONS
            # ══════════════════════════════════════════════════════════════════════
            "Assassin's Kit": "Shiv + pepper spray in one grip. Close AND ranged combat covered. Dark events: auto-win violence with zero damage taken. You're not sure where you learned this. That concerns you.",
            "Fire Launcher": "Road flare loaded into a slingshot. Ranged incendiary that set a dumpster on fire from 50 yards. Night events: clear threats. Adventures: boss damage. The range is concerning.",
            "Tear Gas": "Pepper spray + stink bomb chemistry. A sealed bag that makes eyes water through the container. Dark events: incapacitate all hostiles. Geneva Convention violation in sandwich bag form.",
            "Street Fighter Set": "Shiv in left hand, brass knuckles on right. Full melee arsenal. Dark events: reputation as dangerous — NPCs skip the violence and negotiate. A pedestrian watched you shadowbox and crossed the street.",
            "Survival Bivouac": "Emergency blanket over fire starter kit. Complete shelter that works better than your apartment. Night/survival: cold immunity, skip all weather events. You accidentally fell asleep for forty minutes during testing.",
            "Hydration Station": "Water purifier fed by rain collector. Clean water forever. Illness: waterborne disease immunity. Tastes better than anything from a tap. You've been dehydrated for three days and didn't know it.",
            "Provider's Kit": "Snare trap + fishing rod. Land food and sea food — all food. Survival: food shortage becomes surplus. You're eating like a man with a plan for the first time in weeks.",
            "Fortified Perimeter": "Car alarm wired to trip-wire traps. 50-foot detection radius, triggered by cat-sized intruders. Night: no theft/intrusion/surprises. Calibrated after a stray cat incident.",
            "All-Weather Armor": "Storm suit layered over outdoor shield. You look like HAZMAT meets beach vacation. ALL environmental immunity: heat/cold/rain/sun/insects/chemicals. You tested it in a thunderstorm. Then realized you were standing in a field during a thunderstorm.",
            "Master Key": "Lockpick set + security bypass in one roll-up case. Opens literally anything. Record: gas station bathroom in 2 seconds. Adventures: all hidden rooms accessible. Reusable.",
            "Night Scope": "Headlamp focused through binocular scope. Turns 2am into noon with terrifying clarity. Night: no surprises, full awareness. You can see a raccoon's facial expression at 100 yards. It looked guilty.",
            "SOS Kit": "Signal mirror + smoke flare. Day or night rescue signal visible for miles. Survival: guaranteed rescue under 11 minutes. Emergency services weren't happy about the test. But they found you.",
            "Intelligence Dossier": "Evidence kit + forged documentation. A dossier that could fool the CIA. People/casino: know everyone's secrets and the house edge. The fictional version of you has better credit.",
            "Surveillance Suite": "Spotlight + radio jammer. Counter-intelligence rig. The spotlight catches movement at 200 yards. The jammer kills all signals in the area — including yours. Friendly fire. Adjust the range.",
            "Mind Shield": "Dream catcher woven around worry stone. The anxiety goes quiet. Not gone — behind a wall. Sanity loss -50%. Nightmares impossible. You sleep better than you have in weeks.",
            "Fortune's Favor": "Lucky charm + luck totem bound with copper wire. Every coin lands heads-up. Lotto ticket: $5 winner. The second: $10. Even luck has limits. But the limits moved. Passive: +10% all random chances.",
            "Fate Reader": "Lucky bracelet threaded through fortune cards. The cards deal themselves: Past, Present, Future. Surreal events: always choose right. The Future card shows something. You're not sure you want to know. Consumed after 5 uses.",
            "Lucid Dreaming Kit": "Dream catcher + eldritch candle. The green flame passes through the web. The strings GLOW. Dream events: full control. Choose your content. Always positive sleep. For the first time, the dream asks YOUR permission.",
            "Old Money Identity": "Gentleman's charm + heirloom set. You look like prep school and Martha's Vineyard. Wealth events: billionaire treatment. You're terrified of how easy this was.",
            "New Identity": "Low-profile outfit + forged documents. Complete alias as Michael Torres. Police unfindable. Casino: fresh start on all profiles. You order coffee as Michael. It tastes different.",
            "Beast Tamer Kit": "Animal bait + pet toy. Set it in the grass and animals LINE UP. Orderly. Like students. Animal events: always befriend, never attacked. You said 'Sit.' They all sat. You're a Disney princess now.",
            "Cheater's Insurance": "Devil's deck + evidence kit. One cheats, the other documents the cheat as fair play. Casino: never caught. The most ethically bankrupt thing you've ever built. Also the most useful.",
            "Roadside Shield": "Tire ready kit + power grid. Pre-wired, pre-jacked, pre-everything. Car events: prevent 60% of all troubles. Flat tire AND dead battery fixed in under five minutes. A passing driver assumed you're a mechanic.",
            "Auto Mechanic": "Mobile workshop + miracle lube. Pop the hood, feel the belts, listen to the engine. Your car PURRS for the first time since the dealership. 80% car trouble prevention + instant fix. You scratched the dashboard and said 'Good car.'",
            "Rolling Fortress": "Pursuit package + fortified perimeter. Alarms on every door, traps under the bumper. Theft immunity + chase escape. Your car is a bunker that goes 60 MPH. Mad Max would cry. Sensitivity adjusted after the jogger incident.",

            # ══════════════════════════════════════════════════════════════════════
            # TIER 3 — MASTERWORKS
            # ══════════════════════════════════════════════════════════════════════
            "Road Warrior Armor": "Three weapons fused into a harness. Heavy. Terrifying. Full combat immunity: physical damage nullified, dark events auto-win. You look at yourself in the car window and the person staring back is someone you don't entirely recognize.",
            "Third Eye": "Mind shield + dream kit + fate reader, merged into a headband that HUMS. See outcomes before choosing. Dreams controlled. You see a shimmer around things — people, cars, doors. The next event's shimmer is brightest. Min sanity 50 to use.",
            "Nomad's Camp": "Bivouac + provider's kit + hydration station. Self-sufficient shelter with food and water. No survival event can harm you. You sit in the camp and for the first time, nothing is wrong. The world could end tomorrow. You'd eat breakfast and watch the sunrise.",
            "All-Access Pass": "Master key + night scope + intelligence dossier. Know everything, access everywhere. Every locked door, dark hallway, and hidden password becomes trivial. You are the most informed lock-picker in human history.",
            "Master of Games": "Old money identity + cheater's insurance + enchanted vintage. Casino/social perfection. All events favor you. You could buy a casino with borrowed money and a smile. You don't want to know what kind of person you are for building this.",
            "Immortal Vehicle": "Auto mechanic + rolling fortress + roadside shield. Your car self-diagnoses, self-defends, and nearly self-repairs. It starts before you finish turning the key. It KNEW. No car trouble events. The dashboard blinks twice when you say 'Ready.'",
            "Gambler's Aura": "Fortune's favor + luck totem + smelling salts. Three layers of luck, braided and bound. +15% all random chances. Blackjack always favorable. Coins on the ground catch your eye. The universe has noticed you and it's embarrassed about what it owes.",
            "Ark Master's Horn": "Beast tamer kit + animal bait + feeding station. The horn is just rolled tin, but when you blow it, every bird changes direction toward you. Dogs sit. Cats appear. A fish jumped INTO YOUR HANDS. You are the Ark. The animals chose you.",
            "Guardian Angel": "SOS kit + distress beacon + fortified perimeter. Triple redundancy: three emergency services respond under 8 minutes. Cannot die from lethal damage — it becomes non-lethal. One self-revive stored.",
            "Hazmat Suit": "Gas mask + all-weather armor + storm suit. Full environmental/chemical/weather immunity. Your breathing sounds like Darth Vader. Nobody talks to the hazmat guy. Invulnerable to weather, gas, acid, and social interaction.",
            "Ghost Protocol": "Surveillance suite + new identity + radio jammer. You don't become invisible — you become IRRELEVANT. Cameras don't focus. Dogs don't bark. Eyes slide past you. Zero surveillance, zero tracking. Peaceful. Then terrifying.",
            "Dark Pact Reliquary": "Eldritch candle + binding portrait + devil's deck. The temperature drops five degrees. The reliquary whispers — not words, ALMOST words. Master dark powers. Devil deals favor you. -3 sanity/day. It knows your name. You never told it.",

            # ══════════════════════════════════════════════════════════════════════
            # TIER 4 — LEGENDARY
            # ══════════════════════════════════════════════════════════════════════
            "Beastslayer Mantle": "Road warrior armor + gator tooth. The tooth finds its place like it was always missing. All violence/animal immunity. Physical invincibility. You don't feel human wearing it. You feel like something that hunts humans. A bird of prey circles overhead. Respect.",
            "Seer's Chronicle": "Third eye + hermit's journal. Your handwriting appears on blank pages — but you're not writing. Know every event 10 days ahead. The pages go blank if you read too far. 'You're not ready for that yet.'",
            "Wanderer's Rest": "Nomad's camp + walking stick. Roots ACTUALLY GROW from the planted stick. Self-sufficient + nature heals. +10 HP/day passive. The camp grows a tomato. ONE tomato. It's perfect.",
            "Skeleton Key": "All-access pass + night vision scope. The key doesn't look like a key — it looks like UNDERSTANDING. Unlock ANYTHING. All hidden content. The door's lock EXPLAINS itself to you. Why it was locked. What it's protecting.",
            "King of the Road": "Master of games + junkyard crown. Something in the world shifts. People notice your GRAVITY. All NPCs defer, all games favor you. +$1000/day passive. Authority isn't earned or stolen. It's WORN.",
            "War Wagon": "Immortal vehicle + artisan's toolkit. The car TWITCHES. The steering adjusts to your hand. The engine runs without the key. Mobile fortress with self-repair and combat. Your car isn't just fixed — it's AWAKE.",
            "Moonlit Fortune": "Gambler's aura + moon shard. Fusion at exactly midnight. Luck becomes physics. Permanent +20% blackjack odds. Coins land how you want. Cards fall where they should. The math changed.",
            "Leviathan's Call": "Ark master's horn + kraken pearl. The pearl vibrates near ANY water. Command sea/land creatures. You blow the horn by the river. The water stills. Something acknowledged you from very, very deep down. The fish surface — not summoned. ATTENDING.",
...
# ============================================
    ...
    _DAY_EVENT_TONE = {
        ...
        # ── CRAFTED ITEM EVENTS ─────────────────────────────────────────────────
        # Item-gated events. Present from cheap onward so crafters get payoff.
        # Self-guarding: each event checks has_item() and falls back gracefully.
        # Gadgets
