...
MARVIN_PRICE_ESTIMATES: dict[str, int] = {
    ...
    "Delight Indicator": 3000,
    "Health Indicator": 3000,
    "Dirty Old Hat": 9000,
    "Golden Watch": 11000,
    "Faulty Insurance": 4000,
    "Enchanting Silver Bar": 4000,
    "Sneaky Peeky Shades": 14000,
    "Quiet Sneakers": 5000,
    "Lucky Coin": 4000,
    "Worn Gloves": 7000,
    "Tattered Cloak": 8000,
    "Rusty Compass": 3000,
    "Pocket Watch": 9000,
    "Marvin's Monocle": 5000,
    "Gambler's Chalice": 11000,
    "Twin's Locket": 14000,
    "White Feather": 5000,
    "Dealer's Grudge": 8000,
    "Gambler's Grimoire": 3000,
    "Animal Whistle": 30000,
}
...
WITCH_FLASK_PRICE_ESTIMATES: dict[str, int] = {
    "No Bust": 10000,
    "Imminent Blackjack": 16000,
    "Dealer's Whispers": 10000,
    "Bonus Fortune": 13000,
    "Anti-Venom": 9000,
    "Anti-Virus": 10000,
    "Fortunate Day": 4000,
    "Fortunate Night": 4000,
    "Second Chance": 11000,
    "Split Serum": 11000,
    "Dealer's Hesitation": 8000,
    "Pocket Aces": 17000,
}
...
RANK_TUNER_PROFILES: dict[int, dict[str, float | int]] = {
    0: {
        ...
        "store_balance_gate": 150,
        "store_health_gate": 55,
        "store_sanity_gate": 30,
        "marvin_min_balance": 2500,
        "marvin_floor_buffer": 1200,
    ...
    1: {
        ...
        "store_balance_gate": 350,
        "store_health_gate": 55,
        "store_sanity_gate": 28,
        "marvin_min_balance": 3000,
    ...
    2: {
        ...
        "store_balance_gate": 2800,
        "store_health_gate": 55,
        "store_sanity_gate": 26,
        "marvin_min_balance": 6000,
        "marvin_floor_buffer": 2500,
    ...
    3: {
        ...
        "marvin_min_balance": 16000,
        "marvin_floor_buffer": 6000,
    ...
    5: {
        ...
        "bet_ratio_safe": 0.20,
        "max_ratio": 0.46,
        "pressure_factor": 0.78,
        "surplus_push": 0.68,
        "floor_keep_base": 0.90,
        "floor_keep_mid": 0.84,
        "floor_keep_high": 0.76,
        "store_priority_min": 52,
        "store_balance_gate": 20000,
        "store_health_gate": 48,
        "store_sanity_gate": 20,
        "marvin_min_balance": 120000,
        "marvin_floor_buffer": 35000,
...
CRAFTING_RECIPE_PRIORITIES: dict[str, int] = {
    ...
    "Distress Beacon": 94,
    "Mind Shield": 92,
    "Lucid Dreaming Kit": 90,
    "Auto Mechanic": 90,
    "Rolling Fortress": 89,
    "Roadside Shield": 86,
    "SOS Kit": 84,
    "Fortified Perimeter": 82,
    "Fate Reader": 80,
    "Third Eye": 96,
